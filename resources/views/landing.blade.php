...
<head>
    ...
    <title>Andi's Futsal - Pengalaman Futsal Premium di Bojonegoro</title>
    <meta name="description" content="Rasakan lapangan futsal terbaik di Bojonegoro. Booking permainan Anda hari ini di Andi's Futsal - tempat para juara dibentuk.">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div class="animate-fade-in">
                ...
                <div class="inline-flex items-center px-4 py-2 bg-white/20 backdrop-blur-sm rounded-full text-white/90 text-sm font-medium mb-8 glass-effect">
                    ...
                    Pengalaman Futsal Premium di Bojonegoro
                </div>
                ...
                <p class="text-xl md:text-2xl text-white/90 max-w-4xl mx-auto mb-12 leading-relaxed animate-slide-up" style="animation-delay: 0.4s">
                    Rasakan destinasi futsal terbaik di Bojonegoro. Lapangan premium, fasilitas profesional, dan momen tak terlupakan menanti Anda.
                </p>
    ...
    <section id="features" class="py-24 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                <!-- Feature 1 -->
                <div class="group p-8 bg-gradient-to-br from-slate-50 to-white rounded-2xl border border-slate-200 hover:border-primary-300 hover:shadow-xl transition-all duration-300 hover-lift card-hover loading">
    ...
    <section id="info" class="py-24 bg-gradient-to-br from-slate-50 to-slate-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-16">
                ...
                <p class="text-xl text-slate-600 max-w-3xl mx-auto">
                    Temukan kami di jantung Bojonegoro dengan akses mudah dan parkir yang luas
                </p>
            </div>
            ...
            <div class="grid md:grid-cols-3 gap-8 mb-16">
                ...
                <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover-lift border border-slate-200">
                    ...
                    <p class="text-slate-600 leading-relaxed mb-4">
                        Jl. Yang pernah ada, masalalu, Kec. masadepan, Kota Bojonegoro, universe 28292
                    </p>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="bg-gradient-to-br from-slate-50 to-white p-8 rounded-2xl border border-slate-200 hover:shadow-xl transition-all duration-300 hover-lift">
                    ...
                    <p class="text-slate-600 mb-6 italic">
                        "Lapangan terbaik di Bojonegoro! Rumput sintetis berkualitas tinggi dan fasilitas yang sangat bersih. Tim kami selalu booking di sini."
                    </p>
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-slate-500 text-sm">Team Captain, FC Bojonegoro</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="grid md:grid-cols-4 gap-8">
                ...
                <div class="md:col-span-2">
                    ...
                    <p class="text-slate-300 mb-6 max-w-md">
                        The premier futsal destination in Bojonegoro, offering world-class facilities and unforgettable experiences for players of all levels.
                    </p>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li class="flex items-start">
                            ...
                            <span class="text-slate-300 text-sm">Jl. Yang pernah ada, masalalu, Kec. masadepan, Kota Bojonegoro, universe 28292</span>
                        </li>
                        <li class="flex items-center">
