...
class AdminBookingController extends Controller
{
    ...
    {
        $query = Pesanan::with(['lapangan', 'user']);
    ...
    {
        $pesanan = Pesanan::with(['lapangan', 'user'])->findOrFail($id);
    ...
    public function detail(Request $request)
    {
        ...
        $pesananDiterima = Pesanan::with(['lapangan', 'user'])
    ...
    public function dashboard()
    {
        ...
        $recentBookings = Pesanan::with(['lapangan', 'user'])
